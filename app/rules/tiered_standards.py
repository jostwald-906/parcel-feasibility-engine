...
# Downtown Community Plan (DCP) Tier Multipliers
# CITE: SMMC § 9.07 Downtown Community Plan
...
def compute_max_far(parcel: ParcelBase) -> Tuple[float, str]:
    ...
    if "AHO" in overlay_codes:
        ...
        logger.info(f"Applied AHO bonus (+{AHO_FAR_BONUS}) to FAR: {pre_aho_far} -> {max_far}")
