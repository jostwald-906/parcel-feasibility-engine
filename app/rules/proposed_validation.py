...
def validate_proposed_vs_allowed(
    proposed: ProposedProject, allowed: DevelopmentScenario, parcel_lot_size_sqft: float
            ...
            warnings.append(
                ValidationWarning(
                    ...
                    details={
                        ...
                        "deficit": allowed.parking_spaces_required
                        - proposed.parking.proposed_spaces,
                    },
                )
            )
            ...
            warnings.append(
                ValidationWarning(
                    ...
                    details={
                        ...
                        "excess": proposed.site_configuration.lot_coverage_pct
                        - allowed.lot_coverage_pct,
                    },
                )
            )
